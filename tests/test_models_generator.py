...
class TestGenerateModels:
    ...
    def test_generates_model_files_for_all_schemas(
        self, space_zoo_spec, temp_output_path
    ):
    ...
    def test_generates_models_barrel_export(
        self, space_zoo_spec, temp_output_path
    ):
    ...
    def test_model_has_correct_interface_name(
        self, space_zoo_spec, temp_output_path
    ):
    ...
    def test_model_has_correct_header(
        self, space_zoo_spec, temp_output_path
    ):
    ...
    def test_model_with_imports_has_import_statements(
        self, space_zoo_spec, temp_output_path
    ):
    ...
    def test_model_properties_have_correct_types(
        self, space_zoo_spec, temp_output_path
    ):
    ...
    def test_model_optional_properties_marked_correctly(
        self, space_zoo_spec, temp_output_path
    ):
