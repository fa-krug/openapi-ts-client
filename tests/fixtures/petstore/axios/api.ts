...
;
         ...
         * @throws {RequiredError}
         */
        findPetsByStatus: async (status: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
;
         ...
         * @throws {RequiredError}
         */
        uploadFile: async (petId: number, additionalMetadata?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'petId' is not null or undefined
...
export const PetApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deletePet(petId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async findPetsByStatus(status: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Pet>>> {
         ...
         * @throws {RequiredError}
         */
        async uploadFile(petId: number, additionalMetadata?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.uploadFile(petId, additionalMetadata, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const PetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deletePet(petId: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        findPetsByStatus(status: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<Pet>> {
         ...
         * @throws {RequiredError}
         */
        uploadFile(petId: number, additionalMetadata?: string, options?: RawAxiosRequestConfig): AxiosPromise<ApiResponse> {
            return localVarFp.uploadFile(petId, additionalMetadata, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PetApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    public deletePet(petId: number, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public findPetsByStatus(status: string, options?: RawAxiosRequestConfig) {
     ...
     * @throws {RequiredError}
     */
    public uploadFile(petId: number, additionalMetadata?: string, options?: RawAxiosRequestConfig) {
        return PetApiFp(this.configuration).uploadFile(petId, additionalMetadata, options).then((request) => request(this.axios, this.basePath));
    }
}
