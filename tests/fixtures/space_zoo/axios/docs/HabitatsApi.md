...
|------------- | ------------- | -------------|
|[**_delete**](#_delete) | **DELETE** /api/habitats/{pk} | Delete|
|[**clone**](#clone) | **POST** /api/habitats/{pk}/duplicate | Clone|
|[**count**](#count) | **GET** /api/habitats/count | Count|
|[**create**](#create) | **POST** /api/habitats | Create|
|[**get**](#get) | **GET** /api/habitats/{pk} | Get|
|[**listAll**](#listall) | **GET** /api/habitats | List All|
|[**listNames**](#listnames) | **GET** /api/habitats/names | List Names|
|[**update**](#update) | **PUT** /api/habitats/{pk} | Update|
...
const apiInstance = new HabitatsApi(configuration);
